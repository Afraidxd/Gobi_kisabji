...
async def global_leaderboard(update: Update, context: CallbackContext) -> None:
    ...
    await update.callback_query.message.reply_photo(photo=photo_url, caption=leaderboard_message, parse_mode='HTML')
...
async def leaderboard(update: Update, context: CallbackContext) -> None:
    ...
    keyboard = [
        [InlineKeyboardButton("Group Top", callback_data='ctop')],
        [InlineKeyboardButton("Global Group Top", callback_data='global_leaderboard')],
