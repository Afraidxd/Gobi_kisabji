...
async def srace(update):
    try:
        ...
        print(f"An error occurred in srace: {e}")
...
async def participate(update):
    try:
        ...
        print(f"An error occurred in participate: {e}")
...
async def timeout_race(update):
    try:
        ...
        print(f"An error occurred in timeout_race: {e}")
...
async def start_race(update):
    try:
        ...
        print(f"An error occurred in start_race: {e}")
...
async def remind_to_join(update):
    try:
        ...
        print(f"An error occurred in remind_to_join: {e}")
