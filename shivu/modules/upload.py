...
rarity_map = 1 (⚪️ Common), 2 (🟣 Rare) , 3 (🟡 Legendary), 4 (🟢 Medium), 5 (💮 limited edition), 6 (🏎 Race edition)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💮 limited edition", 6: "🏎 Race edition"}
        try:
